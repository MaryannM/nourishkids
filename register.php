...
<div class="register-box">
  <div class="register-logo">
    <a href="index.html"><b>Nourish</b>Kids</a>
  </div>
    ...
    <div class="card-body register-card-body">
      ...
      ?>
        ...
        <div class="input-group mb-3">
          ...
          <div class="input-group-append">
        <div><small>Please enter a password with at least 8 characters, including uppercase, lowercase, and numeric characters.</small><br>
        <span style="color: red;"><?php if(isset($error)) echo $error; ?></div>
